...
var MapzenBug = (function () {
  ...
  function _buildTwitterLink () {
    ...
    if (opts.tweet) {
      ...
      text = encodeURIComponent(opts.name + ', powered by @transitland')
    } else {
      text = encodeURIComponent('Check out this project by @transitland!')
    }
  ...
  function _createElsAndAppend () {
    ...
    var mapzenTitle = (opts.name) ? opts.name + ' · Powered by Transitland' : 'Powered by Transitland'
